 ...
 */
package com.yz.android.codecompletion;

import com.intellij.codeInsight.template.postfix.templates.JavaPostfixTemplateProvider;
import com.intellij.codeInsight.template.postfix.templates.PostfixTemplate;
import com.intellij.util.containers.ContainerUtil;
import com.yz.android.codecompletion.surround.*;
...
public class AndroidPostfixTemplateProvider extends JavaPostfixTemplateProvider {
    ...
    public AndroidPostfixTemplateProvider() {
        templates = ContainerUtil.<PostfixTemplate>newHashSet(
                ...
                new TextUtilsIsNotEmptyTemplate(),
                new PresenterTemplate(),
                new RxTimerTemplate(),
                new RxIntervalTemplate()
        );
    }
