...
import static com.yz.android.codecompletion.utils.ImportUtils.hasImportStatic;
...
public class AndroidPostfixTemplatesUtils {
    ...
    public static final Condition<PsiElement> IS_NUMBER = new Condition<PsiElement>() {
        @Override
        public boolean value(PsiElement element) {
            return IS_NUMBER.value(element);
        }
    };
    ...
    @Contract("null -> false")
    public static boolean isInt(@Nullable PsiType type) {
        return type != null && InheritanceUtil.isInheritor(type, CommonClassNames.JAVA_LANG_NUMBER);
    }
