 ...
 * @author zhangyf
 */
public class TextUtilsIsNotEmptyTemplate extends AbstractRichStringBasedPostfixTemplate {
    ...
    public TextUtilsIsNotEmptyTemplate() {
        this("isnotempty");
    }

    public TextUtilsIsNotEmptyTemplate(@NotNull String alias) {
